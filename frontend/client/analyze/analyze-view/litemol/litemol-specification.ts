...
import {SequenceView} from "../sequence/sequence-view";

export const LiteMolPrankWebSpecification: LiteMol.Plugin.Specification = {
  "settings": {},
  "transforms": [
  ...
  "components": [
    ...
    LiteMol.Plugin.Components.create("PrankWeb.SequenceView", context => new SequenceController(context), SequenceView)(LiteMol.Bootstrap.Components.LayoutRegion.Top, true),
