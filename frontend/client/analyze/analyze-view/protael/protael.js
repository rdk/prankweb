...
export const Protael = (function () {
   ...
   * @param {boolean} resizable Should be resizable.
   */
  function Protael(protein, container, controls, resizable) {
    if (!(this instanceof Protael)) {
      return new Protael(protein, container, controls, resizable);
    }
  ...
  (function (paperproto) {
    ...
    paperproto.proteinSequence = function (chars, y, showSequence, alignment) {
      ...
      var p = this.paper,
        ...
        rect = p.rect(0, y, this.protael.W, 10).attr({
          "id": "seq_" + label,
          "title": label || "",
          "opacity": 0
        }),
    ...
    paperproto.quantTrack = function (qtrack, topY, width, height) {
      ...
      g.mousemove(function (e) {
        ...
        tooltip.attr({
          "x": x,
          "text": qtrack.label.substring(0, 1) + ".: " + txt
        });
      });
